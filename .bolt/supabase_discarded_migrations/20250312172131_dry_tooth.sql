/*
  # Add Logging System with Safe Operations
...
-- Create action_logs table safely
DO $$ BEGIN
...
DO $$ BEGIN
  DROP POLICY IF EXISTS "Users can create logs" ON action_logs;
  DROP POLICY IF EXISTS "Users can read their own logs" ON action_logs;
  DROP POLICY IF EXISTS "Managers can read all logs" ON action_logs;
EXCEPTION
