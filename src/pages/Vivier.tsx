  ...
  const fetchCandidates = async () => {
    try {
      ...
      let query = supabase
        ...
        `, { count: 'exact' })
        .eq('is_favorite', true); // Only fetch favorite candidates
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold">Vivier de candidats</h1>
            <button
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {candidates.map((candidate) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-2.5 whitespace-nowrap text-sm text-gray-500">
                      {format(new Date(candidate.created_at), "d MMMM yyyy", { locale: fr })}
                    </td>
                  </tr>
                ))}
              </tbody>
